...
router.post('/import', (req, res, next) => {
  try {
    ...
    const insert = db.prepare(`
      INSERT OR IGNORE INTO queries (id, name, query, description, category, table_name, tags, favorite, created, updated)
      VALUES (@id, @name, @query, @description, @category, @table_name, @tags, @favorite, @created, @updated)
    `);
...
router.post('/', (req, res, next) => {
  try {
    const { name, query, description, category, table, table_name, tags, favorite } = req.body;
    ...
    db.prepare(`
      INSERT INTO queries (id, name, query, description, category, table_name, tags, favorite, created, updated)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(
      id,
      name,
